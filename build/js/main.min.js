...
/* harmony import */ var _modules_input_file_init_upload_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/input-file/init-upload.js */ "./js/modules/input-file/init-upload.js");
/* harmony import */ var _modules_input_range_init_input_range_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/input-range/init-input-range.js */ "./js/modules/input-range/init-input-range.js");
/* harmony import */ var _modules_menu_toggle_init_menu_toggle_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/menu-toggle/init-menu-toggle.js */ "./js/modules/menu-toggle/init-menu-toggle.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_input_file_init_upload_js__WEBPACK_IMPORTED_MODULE_3__["uploadImage"])();
    Object(_modules_input_file_init_upload_js__WEBPACK_IMPORTED_MODULE_3__["uploadFile"])();
    Object(_modules_input_file_init_upload_js__WEBPACK_IMPORTED_MODULE_3__["uploadImageDrop"])();
    Object(_modules_input_file_init_upload_js__WEBPACK_IMPORTED_MODULE_3__["uploadFileDrop"])();
    Object(_modules_input_file_init_upload_js__WEBPACK_IMPORTED_MODULE_3__["uploadFileDropPreview"])();
    Object(_modules_input_range_init_input_range_js__WEBPACK_IMPORTED_MODULE_4__["initInputRange"])();
    Object(_modules_menu_toggle_init_menu_toggle_js__WEBPACK_IMPORTED_MODULE_5__["initMenuToggle"])();
  });
});
...
/*!**********************************************!*\
  !*** ./js/modules/input-file/init-upload.js ***!
  \**********************************************/
/*! exports provided: uploadImage, uploadFile, uploadImageDrop, uploadFileDrop, uploadFileDropPreview */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "uploadFileDrop", function() { return uploadFileDrop; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "uploadFileDropPreview", function() { return uploadFileDropPreview; });
/* harmony import */ var _upload_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./upload.js */ "./js/modules/input-file/upload.js");

var uploadImageBlock = document.querySelector('[data-upload="img"]');
var uploadIFileBlock = document.querySelector('[data-upload="file"]');
var uploadImageDropBlock = document.querySelector('[data-upload="img-drop"]');
var uploadFileDropBlock = document.querySelector('[data-upload="file-drop"]');
var uploadFileDropPreviewBlock = document.querySelector('[data-upload="file-drop-preview"]');
var uploadImage = function uploadImage() {
  return new _upload_js__WEBPACK_IMPORTED_MODULE_0__["Upload"](uploadImageBlock, {
    uploadLength: 4,
    dropZone: true,
    preview: true,
    previewImg: true,
...
var uploadFile = function uploadFile() {
  return new _upload_js__WEBPACK_IMPORTED_MODULE_0__["Upload"](uploadIFileBlock, {
    uploadLength: 5,
    preview: true,
    maxFullSize: 1048576,
...
var uploadFileDrop = function uploadFileDrop() {
  return new _upload_js__WEBPACK_IMPORTED_MODULE_0__["Upload"](uploadFileDropBlock, {
    uploadLength: 4,
    dropZone: true,
    maxFileSize: 1048576,
    accept: ['.pdf', '.docx', '.xlsx'],
...
var uploadFileDropPreview = function uploadFileDropPreview() {
  return new _upload_js__WEBPACK_IMPORTED_MODULE_0__["Upload"](uploadFileDropPreviewBlock, {
    uploadLength: 4,
    dropZone: true,
    preview: true,
    maxFileSize: 1048576,
...
/***/ "./js/modules/input-range/init-input-range.js":
/*!****************************************************!*\
  !*** ./js/modules/input-range/init-input-range.js ***!
  \****************************************************/
/*! exports provided: initInputRange */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initInputRange", function() { return initInputRange; });
...
var initInputRange = function initInputRange() {
  var inputsRange = document.querySelectorAll('[data-input-range]');
  inputsRange.forEach(function (item) {
    var inputHtmlElement = item.querySelector('[data-input-range-item]');
    var valueHtmlElement = item.querySelector('[data-input-range-value]');
    console.log(valueHtmlElement);
    if (inputHtmlElement) {
      _vendor_nouislider_js__WEBPACK_IMPORTED_MODULE_0___default.a.create(inputHtmlElement, {
        start: [75],
        step: 1,
        range: {
          'min': [0],
...
/***/ "./js/modules/menu-toggle/init-menu-toggle.js":
/*!****************************************************!*\
  !*** ./js/modules/menu-toggle/init-menu-toggle.js ***!
  \****************************************************/
/*! exports provided: initMenuToggle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMenuToggle", function() { return initMenuToggle; });
var initMenuToggle = function initMenuToggle() {
  var menuButtonHtmlElement = document.querySelector('[data-menu-toggle="button"]');
  var menuHtmlElement = document.querySelector('[data-menu-toggle="nav"]');
  if (!menuButtonHtmlElement || !menuHtmlElement) {
    return;
  }
  var handleMenuButtonHtmlElement = function handleMenuButtonHtmlElement() {
